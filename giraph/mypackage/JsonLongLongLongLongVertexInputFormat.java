...
/**
  ...
  */
public class JsonLongLongLongLongVertexInputFormat extends TextVertexInputFormat<LongWritable, LongWritable, LongWritable> {
  ...
  */
  class JsonLongLongLongLongVertexReader extends
    ...
    @Override
    protected LongWritable getValue(JSONArray jsonVertex) throws JSONException, IOException 
	{
