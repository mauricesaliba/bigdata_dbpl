...
cd $GIRAPH_HOME
#build jar file
/home/temp/masters_dm_assignment/giraph/scripts/makejar_02.sh $code_file
...
$HADOOP_HOME/bin/hadoop jar /usr/local/giraph/myassignment/myjar.jar org.apache.giraph.GiraphRunner mypackage.$code_file --yarnjars myjar.jar --workers 1 --vertexInputFormat org.apache.giraph.io.formats.JsonLongLongLongLongVertexInputFormat --vertexInputPath /user/root/input/$input_file -vertexOutputFormat org.apache.giraph.io.formats.IdWithValueTextOutputFormat --outputPath /user/root/dummy-output
